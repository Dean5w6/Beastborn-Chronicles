    ...
    Private Sub Attack_Tick(sender As Object, e As EventArgs) Handles Attack.Tick
        Select Case Counter
            Case 0
                ...
                PictureBox6.Image = My.Resources.quickFX1
                Counter += 1
                Label4.Visible = True
                Label4.Top -= 10
            Case 1
                PictureBox6.Image = My.Resources.quickFX2
                Counter += 1
                Label4.Top -= 10
            Case 2
                PictureBox6.Image = My.Resources.quickFX3
                Counter += 1
                Label4.Top -= 10
            Case 3
                PictureBox6.Image = My.Resources.quickFX4
                EnemyHP -= Strength
                Label2.Text = EnemyHP
                Counter += 1
                Label4.Visible = False
