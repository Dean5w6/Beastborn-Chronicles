Public Class Stage6
    ...
    Dim EnemyHP As Integer = 100000
    Dim Counter As Integer = 0
    Dim EnemyDamage = 15000
    ...
    Private Sub Attack_Tick(sender As Object, e As EventArgs) Handles Attack.Tick
        Select Case Counter
            Case 7
                ...
                PictureBox6.Image = My.Resources.Orb01
                Counter += 1
                Label4.Visible = True
                Label4.Top -= 10
            Case 8
                PictureBox6.Image = My.Resources.Orb02
                Counter += 1
                Label4.Top -= 10
            Case 9
                PictureBox6.Image = My.Resources.Orb03
                Counter += 1
                Label4.Top -= 10
            Case 10
                PictureBox6.Image = My.Resources.Orb04
                EnemyHP -= Strength
                Label2.Text = EnemyHP
                Counter += 1
                Label4.Visible = False
            ...
            Case 0
                ...
                PictureBox5.Image = My.Resources.CScratch01
                Counter += 1
                Label3.Visible = True
                Label3.Top -= 10
            Case 1
                PictureBox5.Image = My.Resources.CScratch03
                Counter += 1
                Label3.Top -= 10
            Case 2
                PictureBox5.Image = My.Resources.CScratch06
                Counter += 1
                MaxHP -= EnemyDamage
                Label3.Top -= 10
                Label1.Text = MaxHP
            Case 3
                PictureBox5.Image = My.Resources.CScratch08
                Counter += 1
            Case 4
                UserCheck()
                ActionMenu.XP += 30
